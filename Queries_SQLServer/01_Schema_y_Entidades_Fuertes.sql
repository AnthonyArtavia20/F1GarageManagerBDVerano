...
--En este archivo se encuentra la creaci๓n de la BD y las entidades fuertes
...
-- 3. Creaci๓n de entidades Fuertes!!

PRINT 'Creando tabla USER...';
GO
-- *จ*จ*จ*จ*จ*จ*จ*จ*จ*จจ*
CREATE TABLE [USER] (
...
CREATE TABLE SIMULATION (
    ...
    -- NOTA: Las Foreign Keys se agregarแn en el script 04_Foreign_Keys.sql
);
GO
